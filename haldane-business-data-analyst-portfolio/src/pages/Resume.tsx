    ...
    <main>
      ...
      <section className='resume-section'>
        ...
        <ul>
          ...
          <li>
            Collaborated with product, engineering, and design teams to align on
            requirements and system updates.
          </li>
          <li>
          ...
          <li>
            Produced clear, structured documentation to support cross-functional
            teams and end users.
          </li>
        </ul>
        </div>
        ...
        <ul>
          <li>
            Managed high-volume workflows and competing priorities in fast-paced
            environments.
          </li>
          <li>
          ...
          <li>
            Collaborated with cross-functional stakeholders to implement process
            improvements.
          </li>
          <li>
            Investigated discrepancies, identified root causes, and implemented
            targeted solutions.
          </li>
          <li>
            Maintained detailed records and documentation to ensure accuracy and
            accountability.
          </li>
        </ul>
        </div>
      ...
      <section className='resume-section'>
        ...
        <ul>
          ...
          <li>Post-Master Certification (Curriculum, Instruction & Assessment) – Walden University (2023)</li>
